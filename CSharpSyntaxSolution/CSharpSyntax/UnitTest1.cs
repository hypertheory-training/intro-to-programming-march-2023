namespace CSharpSyntax
{
    public class UnitTest1
    {
        ...
        [InlineData(2, 2, 4)]
        [InlineData(10, 2, 12)]
        public void AddAnyInt(int a, int b, int expected)
        {
            int answer = a + b; 
        ...
        {
            UnitTestCustomerClasses Bob = new UnitTestCustomerClasses();

            Assert.Equal(5000, Bob.GetCreditLimit());
            Bob.IncreaseAvailableCredit(50, DateTimeOffset.Now);
            Assert.Equal(5050, Bob.GetCreditLimit());
        }
    }
}
